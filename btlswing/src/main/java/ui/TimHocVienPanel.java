...
public class TimHocVienPanel extends AbstractJpanel {
	...
	public void addComponent() {
		...
		JLabel lblTn = new JLabel("Tên học viên");
		...
		btnQuayLi.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				frame.timHocVienPanel.setVisible(false);
	...
	public void loadData(String str) {
		...
		List<HocVien> hocviens = MainApp.hocvienDao.search(str);
		int stt = 1;
